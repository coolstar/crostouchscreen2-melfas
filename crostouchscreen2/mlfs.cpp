...
NTSTATUS
MlfsProcessIdleRequest(
	IN PMLFS_CONTEXT pDevice,
...
)
{
	...
	*Complete = TRUE;
...

	{
		...
		WDF_WORKITEM_CONFIG_INIT(&workitemConfig, MlfsIdleIrpWorkItem);
...
)
{
	...
	case IOCTL_HID_SEND_IDLE_NOTIFICATION_REQUEST:
		...
		status = MlfsProcessIdleRequest(devContext, Request, &completeRequest);
		break;
